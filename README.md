...
project:
  ...
  evidence:
    - Replace with your public repository URL and current publication status before applying.
    - Replace with real evidence for tested commands, releases, or user-facing documentation.
    - Replace with maintainer workflow evidence such as issue triage, release notes, or application evidence collection.
